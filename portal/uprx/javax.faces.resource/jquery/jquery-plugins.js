...
(function(a, b) {
    ...
    function a(b) {
        if (!b || !b.nodeName || b.nodeName !== "TEXTAREA" || b.hasAttribute("data-autosize-on")) {
            return
        }
        var c;
        var e;
        function f() {
            var h = window.getComputedStyle(b, null);
            if (h.resize === "vertical") {
                b.style.resize = "none"
            } else {
                if (h.resize === "both") {
                    b.style.resize = "horizontal"
                }
            }
            ...
            b.offsetWidth;
            b.style.width = g;
            c = h.maxHeight !== "none" ? parseFloat(h.maxHeight) : false;
            if (h.boxSizing === "content-box") {
                e = -(parseFloat(h.paddingTop) + parseFloat(h.paddingBottom))
            } else {
                e = parseFloat(h.borderTopWidth) + parseFloat(h.borderBottomWidth)
            }
            d()
        }
        function d() {
            ...
            b.style.height = "auto";
            var j = b.scrollHeight + e;
            if (c !== false && c < j) {
                j = c;
                if (b.style.overflowY !== "scroll") {
                    b.style.overflowY = "scroll"
                }
            } else {
                if (b.style.overflowY !== "hidden") {
            ...
            if (g !== b.style.height) {
                ...
                h.initEvent("autosize.resized", true, false);
                b.dispatchEvent(h)
            }
        }
        if ("onpropertychange"in b && "oninput"in b) {
            b.addEventListener("keyup", d)
        }
        window.addEventListener("resize", d);
        b.addEventListener("input", d);
        b.addEventListener("autosize.update", d);
        b.addEventListener("autosize.destroy", function(g) {
            window.removeEventListener("resize", d);
            b.removeEventListener("input", d);
            b.removeEventListener("keyup", d);
            b.removeEventListener("autosize.destroy");
            Object.keys(g).forEach(function(h) {
                b.style[h] = g[h]
            });
            b.removeAttribute("data-autosize-on")
        }
        .bind(b, {
        ...
        b.setAttribute("data-autosize-on", true);
