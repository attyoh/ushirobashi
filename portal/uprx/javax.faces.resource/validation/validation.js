...
if (window.PrimeFaces) {
    ...
    PrimeFaces.validator = {
        "javax.faces.Length": {
            ...
            validate: function(d) {
                ...
                if (a !== undefined && e > a) {
                    throw b.getMessage(this.MAXIMUM_MESSAGE_ID, a, b.getLabel(d))
                }
                if (c !== undefined && e < c) {
                    throw b.getMessage(this.MINIMUM_MESSAGE_ID, c, b.getLabel(d))
                }
            }
        },
        "javax.faces.LongRange": {
            ...
            validate: function(d, e) {
                if (e !== null) {
                    var c = d.data("p-minvalue")
                      , a = d.data("p-maxvalue")
                      , b = PrimeFaces.util.ValidationContext;
                    if (!this.regex.test(d.val())) {
                        throw b.getMessage(this.TYPE_MESSAGE_ID, b.getLabel(d))
                    }
                    if ((a !== undefined && c !== undefined) && (e < c || e > a)) {
                        throw b.getMessage(this.NOT_IN_RANGE_MESSAGE_ID, c, a, b.getLabel(d))
                    } else {
    ...
    PrimeFaces.converter = {
        ...
        "javax.faces.Long": {
            ...
            convert: function(c, a) {
                ...
                var b = PrimeFaces.util.ValidationContext;
                if (!this.regex.test(a)) {
                    throw b.getMessage(this.MESSAGE_ID, a, 98765432, b.getLabel(c))
                }
                return parseInt(a)
            }
        },
        "javax.faces.Double": {
            ...
            convert: function(c, a) {
                ...
                var b = PrimeFaces.util.ValidationContext;
                if (!this.regex.test(a)) {
                    throw b.getMessage(this.MESSAGE_ID, a, 1999999, b.getLabel(c))
                }
                return parseFloat(a)
            }
        },
        "javax.faces.Float": {
            ...
            convert: function(c, a) {
                ...
                var b = PrimeFaces.util.ValidationContext;
                if (!this.regex.test(a)) {
                    throw b.getMessage(this.MESSAGE_ID, a, 2000000000, b.getLabel(c))
                }
                return parseFloat(a)
            }
        },
        "javax.faces.Short": {
            ...
            convert: function(c, a) {
                ...
                var b = PrimeFaces.util.ValidationContext;
                if (!this.regex.test(a)) {
                    throw b.getMessage(this.MESSAGE_ID, a, 32456, b.getLabel(c))
                }
                return parseInt(a)
            }
        },
        ...
        "javax.faces.BigDecimal": {
            ...
            convert: function(c, a) {
                ...
                var b = PrimeFaces.util.ValidationContext;
                if (!this.regex.test(a)) {
                    throw b.getMessage(this.MESSAGE_ID, a, 198.23, b.getLabel(c))
                }
                return parseFloat(a)
            }
        },
        ...
        "javax.faces.Boolean": {
            ...
            convert: function(d, a) {
                ...
                var c = PrimeFaces.util.ValidationContext;
                try {
                    return ((a === "true" || a === "on" || a === "yes") ? true : false)
                } catch (b) {
                    throw c.getMessage(this.MESSAGE_ID, a, c.getLabel(d))
                }
            }
        ...
        "javax.faces.DateTime": {
            ...
            convert: function(e, f) {
                ...
                var h = PrimeFaces.util.ValidationContext
                  , g = e.data("p-pattern")
                  , j = e.data("p-dttype")
                  , b = null
                  , m = null;
                ...
                try {
                    ...
                    if (j === "date") {
                        ...
                        if (j === "time") {
                            throw h.getMessage(this.TIME_ID, f, a, h.getLabel(e))
                        } else {
                            if (j === "both") {
                                throw h.getMessage(this.DATETIME_ID, f, a, h.getLabel(e))
                            }
                        }
                    }
                }
        ...
        "javax.faces.Number": {
            ...
            convert: function(d, e) {
                ...
                var g = PrimeFaces.util.ValidationContext
                  , k = g.getLocaleSettings()
                  , j = d.data("p-notype")
                  , l = d.data("p-maxint")
                  , i = d.data("p-minfrac")
                  , c = d.data("p-intonly");
                if (j === "currency") {
                    ...
                    if (f) {
                        if (e.indexOf(f) === -1) {
                            throw g.getMessage(this.CURRENCY_ID, e, f + "100", g.getLabel(d))
                        } else {
                    ...
                    if (j === "percent") {
                        if (e.lastIndexOf("%") !== (e.length - 1)) {
                            throw g.getMessage(this.PERCENT_ID, e, "50%", g.getLabel(d))
                        } else {
                            e = e.replace(/%/g, "")
                        }
                    }
    ...
    PrimeFaces.validate = function(b) {
        var f = PrimeFaces.util.ValidationContext
          , g = $(b.s).closest("form");
        if (b.a && b.p) {
            var e = PrimeFaces.expressions.SearchExpressionFacade.resolveComponents(b.p)
              , a = $();
            for (var d = 0; d < e.length; d++) {
                if (e[d]) {
                    ...
                    if (c.is(":input")) {
                        ...
                        a = a.add(c.find(":input:visible:enabled:not(:button)[name]"))
                    }
                }
            }
        ...
        if (f.isEmpty()) {
            ...
            if (b.a && b.u) {
                var h = PrimeFaces.expressions.SearchExpressionFacade.resolveComponents(b.u);
    ...
    PrimeFaces.validateInput = function(c) {
        ...
        if (q && c.data("p-required") && (k === null || k === "")) {
            var d = c.data("p-rmsg")
              , h = (d) ? {
                summary: d,
                detail: d
            } : b.getMessage("javax.faces.component.UIInput.REQUIRED", b.getLabel(c));
            b.addMessage(c, h);
            q = false
        }
        if (q && ((p !== null && $.trim(p).length > 0) || PrimeFaces.settings.validateEmptyFields)) {
            var v = c.data("p-val");
            if (v) {
                v = v.split(",");
                for (var t = 0; t < v.length; t++) {
                    var i = v[t]
                      , f = PrimeFaces.validator[i];
                    if (f) {
                        try {
                            f.validate(c, k)
                        } catch (a) {
        ...
        var r = c.data("p-hl") || "default"
          , u = PrimeFaces.validator.Highlighter.types[r];
        if (q) {
            u.unhighlight(c)
        } else {
            u.highlight(c)
    ...
    PrimeFaces.validateInstant = function(f) {
        var e = PrimeFaces.util.ValidationContext
          , d = (typeof f === "string") ? $(PrimeFaces.escapeClientId(f)) : $(f)
          , a = d.data(PrimeFaces.CLIENT_ID_DATA) || d.attr("id")
          , c = d.data("uimessageid")
          , b = null;
        if (c) {
            b = (c === "p-nouimessage") ? null : $(PrimeFaces.escapeClientId(c))
        } else {
        ...
        if (b) {
            b.html("").removeClass("ui-message-error ui-message-icon-only ui-widget ui-corner-all ui-helper-clearfix")
        }
    ...
    PrimeFaces.util.ValidationContext = {
        ...
        getMessage: function(c) {
            var a = this.getLocaleSettings()
              , b = (a.messages && a.messages[c]) ? a : PrimeFaces.locales.en_US;
            var e = b.messages[c]
              , f = b.messages[c + "_detail"];
            if (e) {
        ...
        renderMessages: function(m) {
            var o = m.is("div.ui-messages") ? m : m.find("div.ui-messages")
              , c = o.filter(function(i) {
                return $(o[i]).data("severity").indexOf("error") !== -1
            })
              , t = m.find("div.ui-message")
              , s = m.is(".ui-growl-pl") ? m : m.find(".ui-growl-pl")
              , k = s.filter(function(i) {
                return $(s[i]).data("severity").indexOf("error") !== -1
            });
            t.html("").removeClass("ui-message-error ui-message-icon-only ui-widget ui-corner-all ui-helper-clearfix");
                ...
                for (var u in this.messages) {
                    ...
                    for (var p = 0; p < g.length; p++) {
                        ...
                        if (h.children().length === 0) {
                            h.append('<div class="ui-messages-error ui-corner-all"><span class="ui-messages-error-icon"></span><ul></ul></div>')
                        }
                        var b = $("<li></li>");
                        if (e) {
                            b.append('<span class="ui-messages-error-summary">' + d.summary + "</span>")
                        }
                        if (n) {
                            b.append('<span class="ui-messages-error-detail">' + d.detail + "</span>")
                        }
        ...
        renderUIMessage: function(a, c) {
            ...
            if (b !== "tooltip") {
                a.addClass("ui-message-error ui-widget ui-corner-all ui-helper-clearfix");
                if (b === "both") {
                    a.append('<div><span class="ui-message-error-icon"></span><span class="ui-message-error-detail">' + c.detail + "</span></div>")
                } else {
                    if (b === "text") {
                        a.append('<span class="ui-message-error-detail">' + c.detail + "</span>")
                    } else {
                        if (b === "icon") {
                            a.addClass("ui-message-icon-only").append('<span class="ui-message-error-icon" title="' + c.detail + '"></span>')
                        }
                    }
                }
            } else {
                a.hide();
                $(PrimeFaces.escapeClientId(a.data("target"))).attr("title", c.detail)
            }
        },
        ...
        getLocaleSettings: function() {
            var b = PrimeFaces.settings.locale
              , a = PrimeFaces.locales[b];
            if (!a) {
        ...
        getSubmittedValue: function(a) {
            var b;
            if (a.is(":radio")) {
                b = $('input:radio[name="' + a.attr("name") + '"]:checked').val()
            } else {
                if (a.is(":checkbox")) {
                    b = a.data("p-grouped") ? $('input:checkbox[name="' + a.attr("name") + '"]:checked').val() : a.prop("checked").toString()
                } else {
                    b = a.val()
                }
            }
        ...
        types: {
            ...
            manychkbox: {
                highlight: function(d) {
                    var b = d.closest(".ui-selectmanycheckbox")
                      , a = b.find("div.ui-chkbox-box");
            ...
            listbox: {
                highlight: function(a) {
                    ...
                    PrimeFaces.validator.Highlighter.highlightLabel(a.closest(".ui-inputfield"))
                },
                unhighlight: function(a) {
                    a.closest(".ui-inputfield").removeClass("ui-state-error");
                    PrimeFaces.validator.Highlighter.unhighlightLabel(a.closest(".ui-inputfield"))
                }
            },
            onemenu: {
                highlight: function(a) {
                    a.parent().siblings(".ui-selectonemenu-trigger").addClass("ui-state-error").parent().addClass("ui-state-error");
                    PrimeFaces.validator.Highlighter.highlightLabel(this.getFocusElement(a))
                },
                unhighlight: function(a) {
                    a.parent().siblings(".ui-selectonemenu-trigger").removeClass("ui-state-error").parent().removeClass("ui-state-error");
                    PrimeFaces.validator.Highlighter.unhighlightLabel(this.getFocusElement(a))
                },
                getFocusElement: function(a) {
                    return a.closest(".ui-selectonemenu").find(".ui-helper-hidden-accessible > input")
                }
            },
            spinner: {
                highlight: function(a) {
                ...
                unhighlight: function(a) {
                    ...
                    PrimeFaces.validator.Highlighter.unhighlightLabel(a.parent())
                }
            },
            oneradio: {
                highlight: function(c) {
                    var a = c.closest(".ui-selectoneradio")
                      , d = a.find("div.ui-radiobutton-box");
